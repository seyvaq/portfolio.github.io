...
!(function () {
    var e = {
            ...
            set scheme(e) {
                "auto" == e ? ("dark" == this.preferredColorScheme ? (this._scheme = "dark") : (this._scheme = "light")) : ("dark" != e && "light" != e) || (this._scheme = e), this.applyScheme(), this.schemeToLocalStorage();
            },
            get scheme() {
                return this._scheme;
            },
    ...
    e.addButton({ tag: "BUTTON", class: "contrast switcher theme-switcher", target: "body" }), e.init();
})();
